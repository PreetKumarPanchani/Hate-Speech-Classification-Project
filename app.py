from hateSpeechIdentification.pipeline.train_pipeline import TrainPipeline
...
from hateSpeechIdentification.pipeline.prediction_pipeline import PredictionPipeline
