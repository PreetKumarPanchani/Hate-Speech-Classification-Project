...
from hateSpeechIdentification.components.data_ingestion import DataIngestion
from hateSpeechIdentification.components.data_transforamation import DataTransformation
from hateSpeechIdentification.components.model_trainer import ModelTrainer
from hateSpeechIdentification.components.model_evaluation import ModelEvaluation
from hateSpeechIdentification.components.model_pusher import ModelPusher

from hateSpeechIdentification.entity.config_entity import (DataIngestionConfig,
                                       DataTransformationConfig,
                                       ModelTrainerConfig,
                                       ModelEvaluationConfig,
                                       ModelPusherConfig)

from hateSpeechIdentification.entity.artifact_entity import (DataIngestionArtifacts,
